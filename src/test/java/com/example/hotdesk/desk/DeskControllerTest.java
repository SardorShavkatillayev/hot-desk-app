...
class DeskControllerTest {
        ...
        void createDesk() {
            ...
            ResponseEntity<OfficeResponseDto> officeResponseDtoResponseEntity =
                    restTemplate.postForEntity("/office", officeCreateDTo, OfficeResponseDto.class);
            ...
            ResponseEntity<RoomResponseDto> roomResponseDtoResponseEntity =
                    restTemplate.postForEntity("/room", roomCreateDto, RoomResponseDto.class);
            ...
            ResponseEntity<DeskResponseDto> deskResponseDtoResponseEntity =
                    restTemplate.postForEntity("/desk", createDto, DeskResponseDto.class);
